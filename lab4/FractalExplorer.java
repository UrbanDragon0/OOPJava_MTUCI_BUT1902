...
public class FractalExplorer
{
    ...
    private JImageDisplay display; // ссылка JImageDisplay, для обновления отображения
    ...
    public FractalExplorer(int size) // инициализирует объекты диапазона и фрактального генератора
    {
        displaySize = size;
    ...
    private void drawFractal() //рисует фрактал
    {
    ...
    private class MouseHandler extends MouseAdapter // отслеживаем движение мыши
    {
        @Override
