...
public class nn
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(translateSentence("For The Imperium"));

        // 3
        System.out.println("Задание 3");
        System.out.println(validColor("0, 0, 0"));
        System.out.println(validColor("0, 256, 0"));
        ...
        System.out.println(ulma(206));

        // 7
        System.out.println("Задание 7");
        System.out.println(longestNonrepeatingSubstring("asdasfdasfsdaaaaa"));

        // 8
        System.out.println("Задание 8");
        System.out.println(convertToRoman(56));
        ...
        System.out.println(palindromedescendant(11211330));
