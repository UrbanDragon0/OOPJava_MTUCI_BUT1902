...
public class FractalExplorer
{
    ...
    {
        enableUI(false);//выключаем кнопки пво время перерисовски
    ...
    private class FractalWorker extends SwingWorker<Object, Object> //Класс FractalWorker будет отвечать за вычисление значений цвета для одной строки фрактала
    {
